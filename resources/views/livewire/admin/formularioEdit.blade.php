<div class="container">
    ...
    <form class="form">
        <div class="row g-2">
            <div class="col">
                <input class="relieve" wire:model="usuario.nombre" type="text" placeholder="Nombre"
                    class="form-control">
            ...
            <div class="col">
                <input class="relieve" wire:model="usuario.apellido" placeholder="Apellido" type="text"
                    class="form-control ">
        ...
        <div class="row g-2">
            ...
            <div class="col">
                <input class="relieve" wire:model="confirm_password" type="password"
        ...
        <div class="row g-3">
            <div class="col">
                <input class="relieve" wire:model="usuario.telefono" type="text" class="form-control"
            ...
            <div class="col">
                <input class="relieve" wire:model="usuario.curp" type="text" class="form-control"
            ...
            <div class="col">
                <input class="relieve" wire:model="usuario.rfc" type="text" class="form-control"
        ...
        <div class="row g-3">
            <div class="col">
                <input class="relieve" wire:model="usuario.ine" type="text" class="form-control"
            ...
            <div class="col">
                <input class="relieve" wire:model="usuario.fecha_ingreso" type="date" class="form-control"
            ...
            <div class="col">
                <input class="relieve" wire:model="usuario.fecha_afiliacion" type="date" class="form-control"
